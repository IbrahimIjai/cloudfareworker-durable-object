/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9c202563d13399a4291781f2e91a8c20)
// Runtime types generated with workerd@1.20251109.0 2025-11-13 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		PRIVATE_KEY: string;
		RPC_URL: string;
		CounterScheduler: DurableObjectNamespace<import("./src/index").CounterScheduler>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PRIVATE_KEY" | "RPC_URL">> {}
}
